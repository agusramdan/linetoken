 ...
 */
public class SimpleMultiLineTokenFilter implements MultiLineTokenFilter {
    private final String name;
    private final String start;
    private final String end;
    private final String[] content;

    public SimpleMultiLineTokenFilter(String name, String start, String end, String ... content) {
        this.name = name;
        this.start = start;
        this.end =  end;
